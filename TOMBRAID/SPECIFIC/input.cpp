...
int m_KeyConflict[INPUT_KEY_NUMBER_OF] = {false};
// int m_KeyConflict[INPUT_KEY_NUMBER_OF];
...
S_INPUT_KEYCODE m_Layout[2][INPUT_KEY_NUMBER_OF] = {
        ...
        // default user controls
        {
                ...
                KEY_RIGHT,   // INPUT_KEY_RIGHT
                KEY_HOME,        // INPUT_KEY_STEP_L
                KEY_PRIOR,   // INPUT_KEY_STEP_R
                KEY_SHIFT,   // INPUT_KEY_SLOW
                KEY_MENU,        // INPUT_KEY_JUMP
                KEY_CONTROL, // INPUT_KEY_ACTION
                KEY_SPACE,   // INPUT_KEY_DRAW
                KEY_INSERT,  // INPUT_KEY_LOOK
                KEY_CLEAR,   // INPUT_KEY_ROLL
                KEY_ESCAPE   // INPUT_KEY_OPTION
...
// static int S_Input_DInput_Create();
// static void S_Input_DInput_Shutdown();
// static int S_Input_DInput_KeyboardCreate();
// static void S_Input_DInput_KeyboardRelease();
// static int S_Input_DInput_KeyboardRead();
// static int S_Input_KbdKey(INPUT_KEY key, INPUT_LAYOUT layout);
// static int S_Input_Key(INPUT_KEY key);
...
int S_Input_DInput_KeyboardCreate()
{
...
int S_Input_IsKeyConflicted(INPUT_KEY key) { return m_KeyConflict[key]; }

void S_Input_SetKeyAsConflicted(INPUT_KEY key, int is_conflicted)
{
