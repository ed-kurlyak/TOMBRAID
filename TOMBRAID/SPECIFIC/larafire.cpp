...
void LaraGun()
{
	...
	case LGS_READY:
		...
		{
		case LGT_PISTOLS:
			if (g_Lara.pistols.ammo && g_Input & IN_ACTION)
			{
		...
		case LGT_MAGNUMS:
			if (g_Lara.magnums.ammo && g_Input & IN_ACTION)
			{
				g_Lara.mesh_ptrs[LM_HEAD] =	g_Meshes[g_Objects[O_UZI].mesh_index + LM_HEAD];
			}
			if (g_Camera.type != CAM_CINEMATIC && g_Camera.type != CAM_LOOK)
		...
		case LGT_UZIS:
			if (g_Lara.uzis.ammo && g_Input & IN_ACTION)
			{
				g_Lara.mesh_ptrs[LM_HEAD] =	g_Meshes[g_Objects[O_UZI].mesh_index + LM_HEAD];
			}
			if (g_Camera.type != CAM_CINEMATIC && g_Camera.type != CAM_LOOK)
		...
		case LGT_SHOTGUN:
			if (g_Lara.shotgun.ammo && g_Input & IN_ACTION)
			{
				g_Lara.mesh_ptrs[LM_HEAD] = g_Meshes[g_Objects[O_UZI].mesh_index + LM_HEAD];
			}
			if (g_Camera.type != CAM_CINEMATIC && g_Camera.type != CAM_LOOK)
