...
void Option_Passport(INVENTORY_ITEM *inv_item)
{
        ...
        case 0:
                ...
                else if (m_PassportMode == 0)
                {
                        ...
                        else
                        {
                                if (!g_PassportText)
                                {
                                        g_PassportText = Text_Create(
                                                0, -16, g_GameFlow.strings[GS_PASSPORT_LOAD_GAME]);
                                        Text_AlignBottom(g_PassportText, 1);
                                        Text_CentreH(g_PassportText, 1);
                                }

                                if (g_InputDB & IN_SELECT || g_InvMode == INV_LOAD_MODE)
                                {
        ...
        case 1:
                ...
                else if (m_PassportMode == 0)
                {
                        ...
                        if (g_InputDB & IN_SELECT || g_InvMode == INV_SAVE_MODE)
                        {
                                if (g_InvMode == INV_TITLE_MODE ||
                                        g_CurrentLevel == g_GameFlow.gym_level_num)
                                {
        ...
        */
        ...
        if (g_InputDB & IN_LEFT && (g_InvMode != INV_DEATH_MODE || g_SavedGamesCount))
        {
                while (--page >= 0)
                {
