                         ...
                         col->col_num >= 0 && col->col_num <= 1; col++)
                {
                        ...
                        const char *scancode_name =
                                S_Input_GetKeyCodeName(S_Input_GetAssignedKeyCode(
                                        g_Config.input.layout, (INPUT_KEY)col->option));
...
const TEXT_COLUMN_PLACEMENT *cols = g_Config.enable_cheats
        ...
        */
                 ...
                 item1++)
        {
                ...
                S_INPUT_KEYCODE key_code1 = S_Input_GetAssignedKeyCode(
                        g_Config.input.layout, (INPUT_KEY)item1->option);
                         ...
                         item2->col_num != -1; item2++)
                {
                        ...
                        S_INPUT_KEYCODE key_code2 = S_Input_GetAssignedKeyCode(
                                g_Config.input.layout, (INPUT_KEY)item2->option);
...
void Option_DefaultConflict()
{
        for (int i = 0; i < INPUT_KEY_NUMBER_OF; i++)
        {
                S_INPUT_KEYCODE key_code =
                        S_Input_GetAssignedKeyCode(INPUT_LAYOUT_DEFAULT, (INPUT_KEY)i);
                S_Input_SetKeyAsConflicted((INPUT_KEY)i, false);
                for (int j = 0; j < INPUT_KEY_NUMBER_OF; j++)
                {
                        if (key_code ==
                                S_Input_GetAssignedKeyCode(INPUT_LAYOUT_USER, (INPUT_KEY)j))
                        {
                                S_Input_SetKeyAsConflicted((INPUT_KEY)i, true);
                                break;
                        }
                }
        }
...
const TEXT_COLUMN_PLACEMENT *cols = g_Config.enable_cheats
        ...
        */
        ...
        {
        case 0:
                if (g_InputDB & IN_LEFT || g_InputDB & IN_RIGHT)
                {
                        if (m_KeyChange == -1)
                        {
                        ...
                        else
                        {
                                ...
                                for (sel_col = cols;
                                         sel_col->col_num >= 0 && sel_col->col_num <= 1; sel_col++)
                                {
                                ...
                                for (const TEXT_COLUMN_PLACEMENT *dst_col = cols;
                                         dst_col->col_num >= 0 && dst_col->col_num <= 1; dst_col++)
                                {
                ...
                else if (g_InputDB & IN_DESELECT || (g_InputDB & IN_SELECT && m_KeyChange == -1))
                {
                ...
                if (g_Config.input.layout)
                {
                        ...
                        {
                                Text_RemoveBackground(m_KeyChange == -1 ? m_Text[0]
                                                                                                                : m_TextA[m_KeyChange]);
                                Text_RemoveOutline(m_KeyChange == -1 ? m_Text[0]
                                                                                                         : m_TextA[m_KeyChange]);
                                ...
                                Text_AddBackground(m_KeyChange == -1 ? m_Text[0]
                                                                                                         : m_TextA[m_KeyChange],
                                                                   0, 0, 0, 0);
                                Text_AddOutline(
        ...
        case 2:
        {
                ...
                {
                        S_Input_AssignKeyCode(g_Config.input.layout, (INPUT_KEY)m_KeyChange,
                                                                  key_code);
        ...
        case 3:
        {
                S_INPUT_KEYCODE key_code = S_Input_GetAssignedKeyCode(
                        g_Config.input.layout, (INPUT_KEY)m_KeyChange);
