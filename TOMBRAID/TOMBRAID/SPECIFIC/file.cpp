...
bool S_LoadLevel(char * szLevelName)
{
	...
	//читаем номер версии файла уровн€
	//20h или 32d дл€ Tomb Raider 1
...
bool Load_Rooms(FILE *fp)
{
	...
	for ( int i = 0; i < g_RoomCount; i++ )
	{
        ...
        if (NumDoors)
		{
			...
			//выдел€ем место под двери - число дверей + указатель на массив дверей
...
void ObjectObjects()
{
	...
	//--------------
	//решетка под водой ћидас начало уровн€
	...
	*/
	...
	//взрыв когда муми€ разлетаетс€ на части O_BODY_PART
	...
	//когда взрыв то муми€ разлетаетс€ на части O_EXPLOSION1
