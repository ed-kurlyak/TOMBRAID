...
void LaraAboveWater(ITEM_INFO *item, COLL_INFO *coll)
{
	...
	*/
    ...
    if (g_Camera.type != CAM_LOOK)
	{
        if (g_Lara.head_x_rot > -HEAD_TURN / 2 && g_Lara.head_x_rot < HEAD_TURN / 2)
		{
            g_Lara.head_x_rot = 0;
        }
		else
        ...
        if (g_Lara.head_y_rot > -HEAD_TURN / 2 && g_Lara.head_y_rot < HEAD_TURN / 2)
		{
            g_Lara.head_y_rot = 0;
        }
		else
    ...
    if (g_Lara.turn_rate >= -LARA_TURN_UNDO && g_Lara.turn_rate <= LARA_TURN_UNDO)
	{
        g_Lara.turn_rate = 0;
    }
