...
int16_t *DrawObjectGT4(int16_t *obj_ptr, int32_t number)
{
	...
	do
	{
		...
		if ( !(vns[0]->clip & vns[1]->clip & vns[2]->clip & vns[3]->clip) )
		{
			...
			{
				//псевдоскал€рное косое умножение векторов
				//вы€сн€ем куда смотрит полигон - от зрител€ или к зрителю
		...
		//Skip_ClipVerts:
			...
			else // if && clip
			{
				...
				//если поверхность обращена от зрител€ - пропускаем ее
...
{
	//рисуем саму синюю молнию от “ора
    VBUF2 vertices[8];
	...
	//рисуем белую линию посредине молнии “ора
