...
void DrawLara(ITEM_INFO *item)
{
    ...
    *g_PhdMatrixPtr = saved_matrix;
    ...
    if (g_Lara.gun_status == LGS_READY || g_Lara.gun_status == LGS_DRAW || g_Lara.gun_status == LGS_UNDRAW)
	{
    ...
    case LGT_UZIS:
        ...
        packed_rotation = (int32_t*)(g_Lara.right_arm.frame_base + g_Lara.right_arm.frame_number * (object->nmeshes * 2 + FRAME_ROT) + 10);
        phd_RotYXZ(g_Lara.right_arm.y_rot, g_Lara.right_arm.x_rot, g_Lara.right_arm.z_rot);
        phd_RotYXZpack(packed_rotation[LM_UARM_R]);
        Output_DrawPolygons(g_Lara.mesh_ptrs[LM_UARM_R], clip);
        ...
        packed_rotation = (int32_t*)(g_Lara.left_arm.frame_base + g_Lara.left_arm.frame_number * (object->nmeshes * 2 + FRAME_ROT) + 10);
        phd_RotYXZ(g_Lara.left_arm.y_rot, g_Lara.left_arm.x_rot, g_Lara.left_arm.z_rot);
        phd_RotYXZpack(packed_rotation[LM_UARM_L]);
    ...
    int32_t rate)
{
    ...
    *g_PhdMatrixPtr = saved_matrix;
    ...
    case LGT_UZIS:
        ...
        packed_rotation1 = (int32_t*)(g_Lara.right_arm.frame_base + g_Lara.right_arm.frame_number * (object->nmeshes * 2 + FRAME_ROT) + 10);
        phd_RotYXZ(g_Lara.right_arm.y_rot, g_Lara.right_arm.x_rot, g_Lara.right_arm.z_rot);
