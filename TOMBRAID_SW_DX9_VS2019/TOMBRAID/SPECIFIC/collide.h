...
int32_t TestBoundsCollide(ITEM_INFO *item, ITEM_INFO *lara_item,
						  int32_t radius);
int32_t TestLaraPosition(int16_t *bounds, ITEM_INFO *item,
						 ITEM_INFO *lara_item);
void AlignLaraPosition(PHD_VECTOR *vec, ITEM_INFO *item, ITEM_INFO *lara_item);
int32_t MoveLaraPosition(PHD_VECTOR *vec, ITEM_INFO *item,
						 ITEM_INFO *lara_item);
