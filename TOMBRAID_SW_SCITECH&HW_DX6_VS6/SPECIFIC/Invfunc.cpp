...
int32_t Inv_AddItem(int32_t item_num)
{
	...
	case O_SHOTGUN_ITEM:
	case O_SHOTGUN_OPTION:
		for (i = Inv_RequestItem(O_SG_AMMO_ITEM); i > 0; i--)
		{
	...
	case O_MAGNUM_ITEM:
	case O_MAGNUM_OPTION:
		for (i = Inv_RequestItem(O_MAG_AMMO_ITEM); i > 0; i--)
		{
	...
	case O_UZI_ITEM:
	case O_UZI_OPTION:
		for (i = Inv_RequestItem(O_UZI_AMMO_ITEM); i > 0; i--)
		{
